...
export class DataService {
	...
	private startWatching(): void {
		...
		this.watcher
			.on("add", (filePath) => this.queueFileUpdate(filePath, "add"))
			.on("change", (filePath) => this.queueFileUpdate(filePath, "change"))
			.on("unlink", (filePath) => this.queueFileUpdate(filePath, "unlink"))
			.on("error", (error) => {
	...
	private queueFileUpdate(filePath: string, type: FileChangeEvent["type"]): void {
